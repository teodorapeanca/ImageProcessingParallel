...
#pragma omp parallel for schedule(dynamic)
    ...
    std::cout << "Timp executie paralel (dynamic): " << (end - start) << " secunde" << std::endl;
    std::cout << "Numar thread-uri: " << omp_get_max_threads() << std::endl;

    std::ofstream outFile("C:\\Users\\teodo\\source\\repos\\ImageProcessingParallel\\x64\\Debug\\output_dynamic.ppm");
    ...
    std::cout << "Imaginea paralela (dynamic) a fost salvata in output_dynamic.ppm" << std::endl;
